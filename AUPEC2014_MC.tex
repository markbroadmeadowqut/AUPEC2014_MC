...
% MAHB - compiles OK on laptop but not on work system
...
An introduction with some references to \cite{Broadmeadow2014} and \cite{Broadmeadow2014-2}.

\section{Proposed isolated ADC}
%MAHB: This section should be reworded: clumsy

\section{Coreless PCB transformers}

\section{Topology and operating principles}
